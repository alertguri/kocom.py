...
1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/alertguri/kocom.py 를 입력한 다음 ADD 버튼을 누릅니다.
...
(2025-09-01 수정) 엘리베이터 층수와 도착 센서 추가. 도착 센서는 10초 후 off됨
